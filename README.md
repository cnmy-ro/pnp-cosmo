...
- Rao, van Osch, Pezzotti, de Bresser, van Buchem, Beljaards, Meineke, de Weerdt, Lu, Doneva, Staring. *"A Plug-and-Play Method for Guided Multi-contrast MRI Reconstruction based on Content/Style Modeling"* [(arXiv 2024)](https://arxiv.org/abs/2409.13477)
...
Additionally, PnP-CoSMo was applied in the following works:
...
- Jabarimani, Rao, Ercan, Dong, Pezzotti, Doneva, Weerdt, van Osch, Staring, Nagtegaal. *"Accelerated FLAIR Imaging at 0.6T using T2W-guided Multi-contrast Deep Learning-based Reconstruction using a Zero-shot Approach."* [(ISMRM 2025, Poster)]()
...
This research was conducted at Leiden University Medical Center in collaboration with Philips as part of the [AI4MRI ICAI Lab](https://icai.ai/lab/ai4mri-lab/). This software is for research purposes only and not for clinical use.
